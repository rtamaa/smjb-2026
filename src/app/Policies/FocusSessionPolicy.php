...
class FocusSessionPolicy
{
    ...
    {
        return $user->can('view_any_focus::session');
    }
    ...
    {
        return $user->can('view_focus::session');
    }
    ...
    {
        return $user->can('create_focus::session');
    }
    ...
    {
        return $user->can('update_focus::session');
    }
    ...
    {
        return $user->can('delete_focus::session');
    }
    ...
    {
        return $user->can('delete_any_focus::session');
    }
     ...
     */
    public function replicate(User $user, FocusSession $focusSession): bool
    {
